            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="<?php echo e(route('team')); ?>" class="dropdown-item">Our Tutor</a>
                        <a href="<?php echo e(route('testimonial')); ?>" class="dropdown-item">Testimonial</a>
                        <a href="<?php echo e(route('404')); ?>" class="dropdown-item">404 Page</a>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\fe-learnhub\LearnHub\resources\views/lecturer.blade.php ENDPATH**/ ?>