                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-secondary text-uppercase mb-3 animated slideInDown">Best Online Courses</h5>
                                <h1 class="display-3 text-white animated slideInDown">The Best Online Learning Platform</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Gabung bersama ribuan pelajar yang meningkatkan keterampilan dan pengetahuan mereka melalui platform kami.</p>
                                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">Temukan pengalaman belajar yang fleksibel, terjangkau, dan efektif langsung dari kenyamanan rumah Anda.</p>
                                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\fe-learnhub\LearnHub\resources\views/home.blade.php ENDPATH**/ ?>