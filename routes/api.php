...
Route::get('/tutor/course_id/{course_id}', [TutorController::class, 'getTutorByCourseID']);
Route::get('/tutor/tutor_id/{tutor_id}', [TutorController::class, 'getTutorByID']);
...
Route::delete('/tutorCourse/{id}', [TutorCourseController::class, 'destroy']);

Route::get('/certificate', [CertificateController::class, 'index']);
Route::post('/certificate', [CertificateController::class, 'store']);
Route::put('/certificate/{certificate_id}', [CertificateController::class, 'update']);
Route::delete('/certificate/{certificate_id}', [CertificateController::class, 'destroy']);
